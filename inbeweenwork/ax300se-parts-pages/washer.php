...
<html lang="en">
 ...
 <?php include("../sub-link/head.php"); ?>
	  <meta name="description" content="Grommet Mt. Washer, Alphatek Part # 4158-600-04">
	  <meta name="keywords" content="4158-600-04, Grommet Mt. Washer">
  <title>Grommet Mt. Washer</title>
  </head>
    ...
    <main>
        <div class="center-img">
            ...
            <form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                ...
                <input type="hidden" name="hosted_button_id" value="B4RL9GJ7E9XPJ">
